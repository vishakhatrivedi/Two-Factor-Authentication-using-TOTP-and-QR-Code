...
const API_KEY = "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"; // Paste your API key here
...
const generateResponse = (chatElement) => {
  ...
  fetch(API_URL, requestOptions)
    ...
    .then((data) => {
      ...
      // Initialize variables to track total tokens and the resulting sentence
      let totalTokens = 0;
      let resultSentence = "";

      // Iterate through sentences to create a response with limited tokens
      for (const sentence of sentences) {
        const sentenceTokens = sentence.split(" ").length;

        // Check if adding this sentence exceeds the token limit
        if (totalTokens + sentenceTokens <= 30) {
      ...
      messageElement.textContent = resultSentence;
    })
    .catch(() => {
